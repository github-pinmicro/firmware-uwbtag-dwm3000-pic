...
#define DWT_INT_RXDFR			0x00002000			// receiver data frame ready
...
#define LDO_BIAS_KICK (0x180u)  // Writing to bit 7 and 8
...
(
    uint32_t      regFileID,   // input parameter - ID of register file or buffer being accessed
